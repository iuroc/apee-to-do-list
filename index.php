...
<body>
    ...
    <div class="container pb-4">
        <div class="page-home page-oyp">
            <textarea class="form-control mb-3 shadow-sm _jfgghywsegyferg" placeholder="请输入待办内容" style="height: 100px;"></textarea>
            <div class="font-size-0 d-flex mb-3">
                <button class="btn btn-info shadow-sm d-none d-sm-inline-block">添加待办</button>
                <button class="btn btn-info shadow-sm d-sm-none">添加</button>
                ...
                <div class="_fyhferygfyer ml-3">
                    <dic class="input-group">
                        <input type="date" class="form-control border-danger shadow-sm" id="home-input-needTime">
                        <div class="input-group-append">
                            <button class="btn btn-danger shadow-sm" onclick="$('._fyhferygfyer').hide();$('._wfergerge').show()">取消设置</button>
                        </div>
                    </dic>
                </div>
            </div>
            <div class="data-list">
                <div class="rounded border shadow-sm p-3">
                    <h5 contenteditable="true" class="font-weight-bold">完成一篇论文，考驾照</h5>
        ...
        <div class="page-login page-oyp">
            <div class="row">
                <div class="col-xl-5 col-lg-6 col-md-8 col-sm-10 mx-auto">
                    <div class="rounded border shadow-sm px-3 py-4">
